...
# Matrix for storing upper and lower uncertainty bounds
...
GPBoost_prediction_data <- data.frame(grid@coords,
                                      prev_pred,
                                      var_pred,
                                      lower = lower_and_upper[,1],
                                      upper = lower_and_upper[,2])
...
result <- list(data = GPBoost_prediction_data,
               times = GPBoost_times,
